...
const privateKey = fs.readFileSync(path.resolve(__dirname, config.pkey), "utf8") || config.pkey;
const certificate = fs.readFileSync(path.resolve(__dirname, config.sslcert), "utf8") || config.sslcert;
